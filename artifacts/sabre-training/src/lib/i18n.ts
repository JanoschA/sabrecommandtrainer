...
export const translations = {
  de: {
    ...
    desc_footwork: "Nur reine Fußarbeit (Vor, Zurück, Ausfall, Balestra) – kein Klingentraining.",
    longdesc_footwork: "Reines Fußarbeits-Training ohne fechttechnische Elemente. Vor, Zurück, Ausfall und Balestra stehen im Mittelpunkt – Klingenarbeit entfällt komplett. Ideal um Beinarbeit und Gleichgewicht isoliert zu verbessern.",
    bullet1_footwork: "Inhalt: Vor, Zurück, Ausfall, Balestra",
  ...
  en: {
    ...
    desc_footwork: "Pure footwork only (Advance, Retreat, Lunge, Balestra) – no blade actions.",
    longdesc_footwork: "Pure footwork training with no fencing technique elements. Advance, Retreat, Lunge, and Balestra are the focus – blade work is entirely absent. Ideal for isolating and improving legwork and balance.",
    bullet1_footwork: "Content: Advance, Retreat, Lunge, Balestra",
  ...
  fr: {
    ...
    desc_footwork: "Uniquement le jeu de jambes (Avancer, Reculer, Fente, Balestra) – sans lame.",
    longdesc_footwork: "Entraînement pur du jeu de jambes sans aucun élément de technique d'escrime. Avancer, Reculer, Fente et Balestra sont au centre – le travail de lame est totalement absent. Idéal pour isoler et améliorer le jeu de jambes et l'équilibre.",
    bullet1_footwork: "Contenu: Avancer, Reculer, Fente, Balestra",
