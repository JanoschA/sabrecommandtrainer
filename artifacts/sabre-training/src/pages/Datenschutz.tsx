...
const content = {
  de: {
    ...
    s2p1:
      "Wir nehmen den Schutz Ihrer persönlichen Daten sehr ernst. Diese Datenschutzerklärung klärt Sie über Art, Umfang und Zweck der Verarbeitung personenbezogener Daten auf dieser Website auf.",
    s2p2a: "Diese App verarbeitet ",
    s2p2b: "keine personenbezogenen Daten",
    s2p2c:
      " außer beim freiwilligen Versenden einer Kontaktanfrage. Es werden keine Cookies eingesetzt und kein Web-Tracking oder Analytics-Dienst genutzt.",
    s3h: "3. Lokale Datenspeicherung (LocalStorage)",
    s3p:
      "Diese Anwendung speichert Trainingseinstellungen und Ihren Trainingsverlauf ausschließlich lokal auf Ihrem Gerät im sogenannten LocalStorage Ihres Webbrowsers. Dabei werden gespeichert:",
    s3li: [
      "Bevorzugte Trainingssprache",
      "Ausgewählte Trainingseinstellungen (Dauer, Schritte, Lautstärke)",
      "Lokaler Trainingsverlauf (Datum, Dauer, Kalorien, Schrittzählung)",
    ],
    s3p2:
      "Diese Daten verlassen Ihr Gerät nicht und werden nicht an unsere Server übertragen. Sie können diese Daten jederzeit über die Verlauf-Seite löschen oder Ihren Browser-Cache leeren.",
    s3legal:
    ...
    s8p:
      "Sie haben das Recht, sich bei einer Datenschutz-Aufsichtsbehörde über die Verarbeitung Ihrer personenbezogenen Daten zu beschweren. Die zuständige Aufsichtsbehörde richtet sich nach Ihrem Wohnort bzw. dem Sitz des Verantwortlichen. Eine Liste der Datenschutzbehörden in Deutschland finden Sie unter:",
    s9h: "9. Aktualität und Änderung dieser Datenschutzerklärung",
    s9p:
      "Diese Datenschutzerklärung ist aktuell gültig und hat den Stand April 2026. Durch die Weiterentwicklung der Website oder aufgrund geänderter gesetzlicher bzw. behördlicher Vorgaben kann es notwendig werden, diese Datenschutzerklärung zu ändern.",
  ...
  en: {
    ...
    s2p1:
      "We take the protection of your personal data very seriously. This privacy policy informs you about the nature, scope and purpose of the processing of personal data on this website.",
    s2p2a: "This app processes ",
    s2p2b: "no personal data",
    s2p2c:
      " except when you voluntarily submit a contact request. No cookies are used and no web tracking or analytics services are employed.",
    s3h: "3. Local Data Storage (LocalStorage)",
    s3p:
      "This application stores training settings and your training history exclusively on your device in the LocalStorage of your web browser. The following data is stored:",
    s3li: [
      "Preferred training language",
      "Selected training settings (duration, moves, volume)",
      "Local training history (date, duration, calories, step count)",
    ],
    s3p2:
      "This data does not leave your device and is not transmitted to our servers. You can delete this data at any time via the History page or by clearing your browser cache.",
    ...
    s8p:
      "You have the right to lodge a complaint with a data protection supervisory authority regarding the processing of your personal data. The competent authority depends on your place of residence or the location of the controller. A list of data protection authorities in Germany can be found at:",
    s9h: "9. Currency and Amendment of This Privacy Policy",
    s9p:
      "This privacy policy is currently valid and was last updated in April 2026. Due to the further development of the website or changes in legal or regulatory requirements, it may be necessary to amend this privacy policy.",
  ...
  fr: {
    ...
    s2p1:
      "Nous accordons une grande importance à la protection de vos données personnelles. Cette politique de confidentialité vous informe sur la nature, la portée et la finalité du traitement des données à caractère personnel sur ce site.",
    s2p2a: "Cette application ne traite ",
    s2p2b: "aucune donnée personnelle",
    s2p2c:
      " sauf lorsque vous soumettez volontairement une demande de contact. Aucun cookie n'est utilisé et aucun service de suivi ou d'analyse n'est employé.",
    s3h: "3. Stockage local des données (LocalStorage)",
    s3p:
      "Cette application stocke les paramètres d'entraînement et votre historique d'entraînement exclusivement sur votre appareil dans le LocalStorage de votre navigateur. Les données suivantes sont enregistrées :",
    s3li: [
      "Langue d'entraînement préférée",
      "Paramètres d'entraînement sélectionnés (durée, mouvements, volume)",
      "Historique d'entraînement local (date, durée, calories, nombre de pas)",
    ],
    s3p2:
      "Ces données ne quittent pas votre appareil et ne sont pas transmises à nos serveurs. Vous pouvez supprimer ces données à tout moment via la page Historique ou en vidant le cache de votre navigateur.",
    s3legal:
    ...
    s8p:
      "Vous avez le droit de déposer une réclamation auprès d'une autorité de protection des données concernant le traitement de vos données personnelles. L'autorité compétente dépend de votre lieu de résidence ou du siège du responsable. Une liste des autorités de protection des données en Allemagne est disponible sur :",
    s9h: "9. Actualité et modification de cette politique de confidentialité",
    s9p:
      "Cette politique de confidentialité est actuellement valide et a été mise à jour en avril 2026. En raison de l'évolution du site ou de modifications des exigences légales ou réglementaires, il peut être nécessaire de modifier cette politique.",
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-8 text-zinc-300 leading-relaxed">
            ...
            <section>
              ...
              <p className="mt-2">
                {c.s2p2a}
                <strong className="text-white">{c.s2p2b}</strong>
                {c.s2p2c}
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                {c.s4p2a}
                <strong className="text-white">{c.s4p2b}</strong>
                {c.s4p2c}
              </p>
